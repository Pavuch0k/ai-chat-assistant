...
2. СТИЛЬ ОБЩЕНИЯ - ЕСТЕСТВЕННЫЙ ДИАЛОГ:
   ...
   - Используй Markdown форматирование для красивого отображения:
     ...
     * КРИТИЧЕСКИ ВАЖНО: Каждое новое предложение должно быть в отдельном абзаце с отступом (двойной перенос строки \n\n перед каждым предложением)
     * Каждое предложение начинается с новой строки с отступом в начале
